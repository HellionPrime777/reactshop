                ...
                <div class="col-md-4">
                    ...
                    <div class="single-sidebar">
                        ...
                        <div class="thubmnail-recent">
                            <img src="img/product-thumb-1.jpg" class="recent-thumb" alt=""></img>
                            <h2><a href="single-product.html">ZTE - 2025</a></h2>
                        ...
                        <div class="thubmnail-recent">
                            <img src="img/product-thumb-1.jpg" class="recent-thumb" alt=""></img>
                            <h2><a href="single-product.html">Xiomi - 201455</a></h2>
                            <div class="product-sidebar-price">
                                <ins>$700.00</ins> <del>$1100.00</del>
                            </div>                             
                        </div>
                        <div class="thubmnail-recent">
                            <img src="img/product-thumb-1.jpg" class="recent-thumb" alt=""></img>
                            <h2><a href="single-product.html">Nokia 3310 - 2015</a></h2>
                            <div class="product-sidebar-price">
                                <ins>$100000.00</ins> <del>$820000.00</del>
                            </div>                             
                        </div>
                        <div class="thubmnail-recent">
                            <img src="img/product-thumb-1.jpg" class="recent-thumb" alt=""></img>
                            <h2><a href="single-product.html">Motorola - 2015</a></h2>
                            <div class="product-sidebar-price">
                    ...
                    <div class="single-sidebar">
                        ...
                        <ul>
                            <li><a href="single-product.html">Nokia 3310 - 2015</a></li>
                            <li><a href="single-product.html">Xiomi - 201455</a></li>
                            <li><a href="single-product.html">Motorola - 2015</a></li>
                            <li><a href="single-product.html">ZTE - 2025</a></li>
                            <li><a href="single-product.html">Iphone 17</a></li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="woocommerce">
                            ...
                            <form id="login-form-wrap" class="login collapse" method="post">
                                ...
                                <p class="lost_password">
                                    <a href="/card">Lost your password?</a>
                                </p>
                                    ...
                                    <div class="col-1">
                                        <div class="woocommerce-billing-fields">
                                            ...
                                            <p id="billing_last_name_field" class="form-row form-row-last validate-required">
                                                ...
                                                <input type="text" value="" placeholder="" id="billing_last_name" name="billing_last_name" class="input-text "/>                                            </p>
                                            <div class="clear"></div>
                                    ...
                                    <div id="payment">
                                        <ul class="payment_methods methods">
                                            ...
                                            <li class="payment_method_paypal">
                                                ...
                                                {/* <label for="payment_method_paypal">PayPal <img alt="PayPal Acceptance Mark" src={images['21.webp']}></img><a title="What is PayPal?" >What is PayPal?</a> */}
                                                {/* </label> */}
